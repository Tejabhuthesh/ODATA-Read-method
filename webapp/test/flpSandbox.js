		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ODATA Title",
									"targetURL": "#idODATAodataproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idODATAodataproject1-display": {
								"semanticObject": "idODATAodataproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idODATA.odataproject1",
									"url": sap.ui.require.toUrl("idODATA/odataproject1")
								}
							}
						}
					}
